...
public class Chickens02 {
    ...
    public Chickens02(int mondayEggs, int tuesdayEggs, int wednesdayEggs, double eggPrice) {
    ...
    public static void main(String[] args) {
        ...
        Chickens02 chickens = new Chickens02(mondayEggs, tuesdayEggs, wednesdayEggs, eggPrice);
